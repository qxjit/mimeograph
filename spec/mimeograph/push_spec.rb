...
describe "mimeograph push" do
  ...
  it "should copy all files from source to destination" do
    ...
    mimeograph(:push, source, destination).should be_successful
  ...
  it "should honor specified file exclusions" do
    ...
    mimeograph(:push, source, destination, exclusions.path).should be_successful
